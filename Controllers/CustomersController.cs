...
namespace Muresan_Razvan_Lab2.Controllers
{
    public class CustomersController : Controller
    {
        ...
        private string _baseUrl = "https://localhost:7082/api/Customers";
        ...
        public async Task<ActionResult> Index()
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                customers.ForEach((customer) => customer.City = _context.City.FirstOrDefault(c => c.Id == customer.CityID));
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                customer.City = _context.City.FirstOrDefault(c => c.Id == customer.CityID);
        ...
        public async Task<ActionResult> Create([Bind("CustomerID,Name,Address,BirthDate,CityID")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind("CustomerID,Name,Address,BirthDate,CityID")] Customer customer)
        {
            ViewData["CityID"] = new SelectList(_context.City, "Id", "Name");
